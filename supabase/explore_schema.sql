...
alter table public.explore_posts add column if not exists media_meta jsonb not null default '{}'::jsonb;
...
set
  ...
  moderation_status = case
    when moderation_status in ('approved', 'pending', 'blocked', 'legacy') then moderation_status
    else 'legacy'
  end,
