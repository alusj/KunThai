...
export let previewCases = [
  {
    ...
    subject_user_id: "user-1", assignee_user_id: null, created_at: hoursAgo(1.2), updated_at: hoursAgo(1.2), sla_due_at: hoursAhead(0.8),
  ...
  },
  {
    ...
    subject_user_id: "user-2", assignee_user_id: "preview-user", created_at: hoursAgo(2.8), updated_at: hoursAgo(1.5), sla_due_at: hoursAgo(0.3),
