...
export let previewCases = [
  {
    ...
    metadata: { source: { full_name: "Mohamed Kamara", city: "Freetown", display_code: "KT-18426" } },
  },
  {
    ...
    metadata: { source: { reason: "Threatening language", report_count: 6, author_name: "Account under review" } },
  },
  {
    ...
    metadata: { source: { business_name: "Kallon Home Supplies", city: "Bo", request_type: "seller_verification" } },
  },
  {
    ...
    metadata: { source: { passenger_name: "Aminata Jalloh", topic: "Fare dispute", trip_id: "KT-TRIP-921" } },
  },
  {
    ...
    metadata: { source: { case_type: "order_dispute", order_id: "UR-48320" } },
  },
  {
    ...
    metadata: { source: { report_type: "road_block", address: "Congo Cross, Freetown" } },
  },
  {
    ...
    metadata: { source: { reason: "Impersonation", username: "@dailyfreetown_copy" } },
  },
];
