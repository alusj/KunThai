          ...
          <tbody className="divide-y divide-zinc-100">
            {cases.map((item) => (
              <tr key={item.id} className="group hover:bg-zinc-50">
                ...
                <td className="px-4 py-3">
                  <button type="button" title="Open case" onClick={() => onOpen(item)} className="grid h-8 w-8 place-items-center rounded-md text-zinc-400 hover:bg-zinc-200 hover:text-zinc-950">
