...
export default function VideoProgress({ currentTime = 0, duration = 0, onSeek }) {
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 z-30 px-4 pb-2 text-white sm:px-5" onClick={stopVideoToggle}>
      ...
      <div className="pointer-events-none relative">
        ...
        <span
          className="absolute top-1/2 h-3 w-3 rounded-full bg-white shadow-[0_0_0_3px_rgba(15,23,42,0.35)]"
      ...
      <input
        ...
        className="absolute inset-x-4 bottom-0 h-8 cursor-pointer touch-none appearance-none bg-transparent opacity-0 disabled:cursor-default sm:inset-x-5"
      />
    </div>
  );
}
